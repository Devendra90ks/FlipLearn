...
public class ProfileTestCases extends DriverSession{
	...
	@Test(priority=1)
	public void validatePersonalInformation() throws Exception {
		...
		String StudentName,AdmissionNo,DateOfBirth, RollNo,EmailId,Gender,MobileNo;
		for(i=2;i<rowCount+1;i++){
			...
			Thread.sleep(3000);
			Assert.assertEquals(profile.getStudentName(), StudentName, "Student name matched");
			Assert.assertEquals(profile.getAdmissionNo(), AdmissionNo, "AdmissionNo matched");
			Assert.assertEquals(profile.getEmail(), EmailId, "EmailId matched");
			Assert.assertEquals(profile.getRollNo(), RollNo, "RollNo matched");
			Assert.assertEquals(profile.getGender(), Gender, "Gender matched");
	...
	@Test(priority=3)
	public void validateAdminProfile() throws Throwable{
	...
	@Test(priority=4)
	public void validateTeacherProfile() throws Throwable{
