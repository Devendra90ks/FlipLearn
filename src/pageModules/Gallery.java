...
public class Gallery {
	...
	public static By Delete_Btn=By.xpath("//button[contains(@class,'delete-post z-index ng-binding')]");
	...
	public void clickOnDeleteAlbum(){
		WebElement element = driver.findElement(By.xpath("//button[contains(@class,'delete-post')]"));
		Actions actions = new Actions(driver);
		actions.moveToElement(element);
		actions.perform();
		driver.findElement(By.xpath("//button[contains(@class,'delete-post')]")).click();
	}
