...
public class FeePayment {
	...
	public static By proceedButton = By.xpath("//button[@class='btn btn-primary padding-10-60 m-t-28 mobileTopBottom']");
	...
	public static By flipLearn_link = By.partialLinkText("www.fliplearn.com");
	...
	public void selectSchool(String input) throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(selectSchool));
		if(input.equals("")){
	...
	public void enterStudentNumber(String input) throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(uniqueStudentNumber));
		if(input.equals("")){
	...
	public void confirmDetails() throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(confirmProceed));
	...
	public void fillParentsDetails(String pname, String pMobile, String pEmail, String pAddress, String pState) throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(parentName));
