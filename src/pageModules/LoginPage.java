...
public class LoginPage{
	...
	public static By Username_Txt=By.xpath("//input[@id='Fname']");
	public static By Password_Txt=By.xpath("//input[@id='password-lg1']");
	public static By Password_Error=By.xpath("//div[contains(text(),'Please enter your password')]");
	public static By Login_Error=By.xpath("//div[contains(text(),'Please enter your Login ID')]");
	...
	public static By Submit_btn=By.xpath("//button[@class='btn btn-primary paddingLR z-index btn-style ng-scope']");
	public static By Forget_SuccessMsg=By.xpath("//p[@class='margin-tb']");
	public static By BackToLogin_btn=By.xpath("//a[@class='btn btn-primary paddingLR z-index btn-style']");
	...
	public static By Forget_P_Next_btn=By.xpath(".//*[@id='forgot-password']/div/div/div/div/div[3]/button");
	...
	public void ClickOnLogin_link(){
		GenericFunctions.WaitFor_visibility(driver, driver.findElements(Login_link).get(0));
	...
	public void skipMobileNumber(){
		...
		GenericFunctions.WaitFor_visibility(driver, element);
		element.click();
	}
	
	public void  ForgetUserId(String mobileNo ) throws Exception{
		generic.waitPageGotLoad();
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(UserId_link));
