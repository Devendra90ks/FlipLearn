...
public class UserRegistraionPage {
	...
	public static By Get_Started = By.xpath("//button[@class='btn btn-primary padding-10-30 m-t-28 margin-bottom-0']");
	public static By School_Confirm = By.xpath("//button[@class='btn btn-primary padding-10-60']");
	...
	public static By Continue = By.xpath("//button[@class='btn btn-primary paddingLR marginR20 ng-scope']");
	...
	public void school_confirmation_to_create_role() throws Exception{
		...
		try {
			...
			if(driver.getPageSource().contains("None of the above")){
					...
					Thread.sleep(1000);
					List<WebElement> Confirm_Account = driver.findElements(By.xpath("//label[@class='css-label radGroup2']"));
					Thread.sleep(2000);
					Confirm_Account.get(1).click();
			}
		}
