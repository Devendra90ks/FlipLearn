...
public class Profile {
	...
	public static By save_btn=By.xpath("//button[@class='btn btn-primary padding-10-60 m-t-15 m-b-15']");
	public static By getPersonalInfo=By.xpath("//h3[@class='ng-binding']");
	public static By enterMobileNo=By.id("mobileno");
	public static By sendOTP=By.xpath("//button[@class='btn btn-primary padding-10-60 m-t-15 margin-bottom-0 letterSp']");
	...
	public static By StudentName_errorMsg=By.xpath("//div[@class='error-top ng-scope']");
	...
	public void clickOnVerify_btn(){
		driver.findElements(verify_btn).get(3).click();
	}
	...
	public void clickOnchange_btn(){
		driver.findElements(change_btn).get(1).click();
	}
	...
	public boolean checkStudentNameMandatory() throws InterruptedException{
		...
		if(ActualError.equalsIgnoreCase("Please enter your first name")){
			return true;
		}
		else{
			return false;
	...
	public boolean checkAdminNameMandatory() throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(AdminName_txt));
	...
	public boolean checkTeacherNameMandatory() throws InterruptedException{
		GenericFunctions.WaitFor_visibility(driver, driver.findElement(TeacherName_txt));
	...
	public String getStudentName(){
		String StudentName = driver.findElements(getPersonalInfo).get(0).getText();
		return StudentName;
	}
